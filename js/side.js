;(function($, win, doc) {
  ...
  var $doc = $(doc),
      ...
      source = '\
        ...
        <div class="menu">\
          <menu>\
              <li><a href="https://github.com/<%=$.spring.config.owner%>/<%=$.spring.config.repo%>/issues?state=open" data-href="#" class="taplink">Home4</a></li>\
          </menu>\
          ...
          <%}%>\
          <menu>\
            <li><a href="https://github.com/<%=$.spring.config.owner%>/<%=$.spring.config.repo%>/issues?state=open" target="_blank"> GitHub</a></li>\
          </menu>\
